...
def open_password_reset_window(login_app):
    def check_user_details():
        ...
        if result:
            ...
            cancel_button1.grid(row=2, column=1, sticky="w", pady=10, padx=70)
            submit_button.grid(row=2, column=1, pady=10, padx=100)
        else:
    ...
    cancel_button = tk.Button(frame, text="Cancel", font=("Ink Free", 16, "bold"), command=cancel)
    cancel_button.grid(row=3, column=1, sticky="w", pady=10, padx=70)
    next_button = tk.Button(frame, text="Next", font=("Ink Free", 16, "bold"), command=check_user_details)
    ...
    submit_button = tk.Button(frame, text="Submit", font=("Ink Free", 16, "bold"), command=reset_password)
    cancel_button1 = tk.Button(frame, text="Cancel", font=("Ink Free", 16, "bold"), command=cancel)
